...
/* constants */
const SUB_DOC_SCHEMA_OPTIONS = ({ _id: false, id: false, emitIndexError: true });
...
const Code = new Schema({
  /**
   * @name given
   * @description Human readable given code of the alert e.g NMF etc. If not
   * specified it will be generated from nature, family and name of
   * incident type.
   *
   * @type {object}
