...
const DEFAULT_DISASTER_PHASE = getStrings('DEFAULT_DISASTER_PHASE', 'Mitigation')
...
const IncidentTypeSchema = new Schema({
  ...
  color: {
   ...
   /**
   * @name Phases
   * @description Disaster management phases activated during incident creation
   *
   * @type {object}
   * @property {object} type - schema(data) type
...
IncidentTypeSchema.static.DISASTER_PHASES = DISASTER_PHASES;
