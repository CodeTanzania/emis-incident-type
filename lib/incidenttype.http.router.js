 ...
 * @apiSuccess {String} name Human readable name of the incident type(or main event)
 * e.g Flood etc.
 ...
 * @apiSuccess {String} [color] A color code(in hexadecimal format) used to differentiate
 ...
 * used to differentiate incident types visually.
